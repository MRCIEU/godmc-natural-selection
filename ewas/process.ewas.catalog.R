...
#                  7262                   1473                  14751 
#                  Bone                 Cancer         Cardiovascular 
#                     3                   1872                     39 
#              Cytokine                   Diet              Education 
#                  175                     25                    166 
#            Glycemic           Hypertension      IgG glycosylation 
#                   127                    160                      6 
#   Immune cell subset          Immune system                 Kidney 
#                    13                    217                     99 
#                 Lipid                  Liver          Lung function 
#                   648                     51                    125 
#                Metals Neurological disorders       Oxidative Stress 
#                     4                     13                    106 
# Psychiatric disorders           Reproductive            Respiratory 
#                  2301                   4328                     41 
#                   Sex       Thyroid function               Vitamins 
#                 36052                      7                      2 
...
names(outcpg)<-c("cpg","n_ewas","n_ewas_sig","ewas_minP","ewas_max_P","ewas_pheno_uniq","ewas_pheno_category_uniq")
